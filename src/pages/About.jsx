          ...
          >
            ...
            <Grid container spacing={4} justifyContent="center">
              {[
                {
                  name: "Binyam Angamo",
                  roles: ["UI/UX design and style guide", "Frontend development", "Backend support"],
                ...
                {
                  name: "Lu Hoa",
                  roles: ["Frontend lead", "Backend support"],
                  icon: CodeIcon,
                  profilePicture: null,
                ...
                {
                  name: "Elias Bekele",
                  roles: ["Backend lead", "Authentication implementation", "Payment system integration", "API development"],
                  icon: VpnKeyIcon,
                  profilePicture: null,
                  linkedinUrl: null, // Add LinkedIn URL when available
                },
                {
                  ...
                  roles: ["Backend lead", "Database integration"],
                  icon: StorageIcon,
                  profilePicture: null,
                  linkedinUrl: null, // Add LinkedIn URL when available
                },
                {
                  name: "Shihab Mahfuz",
                  roles: ["Team email account setup", "Initial footer component structure"],
                  icon: EmailIcon,
                  profilePicture: null,
                  linkedinUrl: null, // Add LinkedIn URL when available
                },
